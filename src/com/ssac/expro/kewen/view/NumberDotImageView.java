...
public class NumberDotImageView extends ImageView {
	 private static final int DOT_RADIUS = 3;//选中的点的半径
	  ...
	  private void init()
	  {
	    ...
	    this.mUnSelectPaint.setColor(getResources().getColor(R.color.poe_dot_home_color));
...
//	    this.mSelectPaint.setColor(getResources().getColor(R.color.ssl_white));
	    this.mSelectPaint.setColor(getResources().getColor(R.color.poe_dot_home_color_selector));
